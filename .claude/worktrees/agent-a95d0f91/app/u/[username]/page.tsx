      ...
      <nav className="sticky top-0 z-30 px-6 md:px-10 h-14 flex items-center justify-between backdrop-blur-md border-b"
        ...
        <Link href="/" className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-xl flex items-center justify-center" style={{ background: '#1a1a1a' }}>
            <Star className="w-4 h-4 fill-current" style={{ color: '#ADEE66' }} />
          </div>
          <span className="text-sm font-bold tracking-tight" style={{ color: t.logoText, transition: 'color 0.3s' }}>FestForms</span>
        </Link>
      ...
      <footer className="relative z-10 text-center pb-12 pt-4">
        <Link href="/" className="inline-flex items-center gap-2">
          <div className="w-6 h-6 rounded-lg flex items-center justify-center" style={{ background: '#1a1a1a' }}>
            <Star className="w-3.5 h-3.5 fill-current" style={{ color: '#ADEE66' }}/>
          </div>
          <span className="text-xs" style={{ color: t.footerText }}>
            Powered by <strong style={{ color: t.footerBold }}>FestForms</strong>
          </span>
        </Link>
      </footer>
    </div>
