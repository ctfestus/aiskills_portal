    ...
    <main data-theme="dark" className="min-h-screen text-white overflow-x-hidden" style={{ background: '#0703c2' }}>
      ...
      >
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-sm font-semibold tracking-tight">AI Skills Africa</span>
        </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-white/50 text-sm">professionals trust AI Skills Africa</span>
            </div>
          </motion.div>
      ...
      <section className="py-24 px-6 max-w-5xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <FadeIn className="space-y-5">
            ...
            <p className="text-white/55 leading-relaxed">AI Skills Africa gives you the tools to build, publish, and analyse forms without writing a single line of code.</p>
            <Link href={user ? '/dashboard' : '/auth'}
        ...
        <FadeIn>
          <div className="relative max-w-4xl mx-auto rounded-3xl p-12 md:p-16 text-center overflow-hidden border border-white/15"
            ...
            <div className="relative z-10 space-y-6">
              <img src="https://jbdfdxqvdaztmlzaxxtk.supabase.co/storage/v1/object/public/Assets/brand_assets/powered%20by%20FestMan%20(1).png" alt="AI Skills Africa" className="h-14 w-auto mx-auto" />
              <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-white">
                Ready to build something{' '}
                <span className="italic" style={{ color: '#ff9933', fontFamily: 'Georgia, serif' }}>great?</span>
              </h2>
              <p className="text-white/60 text-lg max-w-lg mx-auto">
                Join creators building forms, courses, and events with AI Skills Africa. Free to start, no credit card required.
              </p>
              <Link href={user ? '/dashboard' : '/auth'}
      ...
      <footer className="border-t border-white/10 px-6 py-10">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-sm font-semibold text-white">AI Skills Africa</span>
          </div>
          <p className="text-xs text-white/30">© {new Date().getFullYear()} AI Skills Africa. Build better forms.</p>
